 ...
 * @author byron
 */
public class AdministradorDocente extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorDocente
     */
    public AdministradorDocente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÉDULA", "NOMBRE", "APELLIDO", "FECHA NACIMIENTO", "TELÉFONO", "CORREO", "RANGO"
            }
        ));
        ...
        jLabel1.setText("ADMINISTRADOR DOCENTES");
        ...
        jLabel11.setText("ASIGNATURA 1");

        jLabel12.setText("ASIGNATURA 3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradorDocente().setVisible(true);
            }
        });
    }
