 ...
 * @author byron
 */
public class AdministradorAsignaturas extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorAsignaturas
     */
    public AdministradorAsignaturas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADMINISTRADOR ASIGNATURAS");

        jLabel2.setText("CÓDIGO");

        jLabel3.setText("NOMBRE");

        jLabel4.setText("CURSO ASIGNADO");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOMBRE", "DESCRIPCIÓN", "CURSO"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorAsignaturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradorAsignaturas().setVisible(true);
            }
        });
    }
